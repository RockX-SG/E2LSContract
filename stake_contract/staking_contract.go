...
// GetMaxToStop is a free data retrieval call binding the contract method 0xbe9d96a0.
//
// Solidity: function getMaxToStop() view returns(uint256)
func (_StakingContract *StakingContractCaller) GetMaxToStop(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _StakingContract.contract.Call(opts, &out, "getMaxToStop")
...
//
// Solidity: function getMaxToStop() view returns(uint256)
func (_StakingContract *StakingContractSession) GetMaxToStop() (*big.Int, error) {
	return _StakingContract.Contract.GetMaxToStop(&_StakingContract.CallOpts)
}

// GetMaxToStop is a free data retrieval call binding the contract method 0xbe9d96a0.
//
// Solidity: function getMaxToStop() view returns(uint256)
func (_StakingContract *StakingContractCallerSession) GetMaxToStop() (*big.Int, error) {
	return _StakingContract.Contract.GetMaxToStop(&_StakingContract.CallOpts)
}
...
func (_StakingContract *StakingContractCaller) ValidatorRegistry(opts *bind.CallOpts, arg0 *big.Int) (struct {
	Pubkey    []byte
	Signature []byte
	Stopped   bool
	Restaking bool
	...
	var out []interface{}
	err := _StakingContract.contract.Call(opts, &out, "validatorRegistry", arg0)
...
//
// Solidity: function validatorRegistry(uint256 ) view returns(bytes pubkey, bytes signature, bool stopped, bool restaking, uint8 eigenpod)
func (_StakingContract *StakingContractSession) ValidatorRegistry(arg0 *big.Int) (struct {
	Pubkey    []byte
	Signature []byte
	Stopped   bool
	Restaking bool
	...
	return _StakingContract.Contract.ValidatorRegistry(&_StakingContract.CallOpts, arg0)
}

// ValidatorRegistry is a free data retrieval call binding the contract method 0x5a1239c1.
//
// Solidity: function validatorRegistry(uint256 ) view returns(bytes pubkey, bytes signature, bool stopped, bool restaking, uint8 eigenpod)
func (_StakingContract *StakingContractCallerSession) ValidatorRegistry(arg0 *big.Int) (struct {
	Pubkey    []byte
	Signature []byte
	Stopped   bool
	Restaking bool
...
func (_StakingContract *StakingContractTransactor) RegisterRestakingValidators(opts *bind.TransactOpts, pubkeys [][]byte, signatures [][]byte, podIds []uint8) (*types.Transaction, error) {
	return _StakingContract.contract.Transact(opts, "registerRestakingValidators", pubkeys, signatures, podIds)
}

// RegisterRestakingValidators is a paid mutator transaction binding the contract method 0x0a1521fc.
//
// Solidity: function registerRestakingValidators(bytes[] pubkeys, bytes[] signatures, uint8[] podIds) returns()
func (_StakingContract *StakingContractSession) RegisterRestakingValidators(pubkeys [][]byte, signatures [][]byte, podIds []uint8) (*types.Transaction, error) {
	return _StakingContract.Contract.RegisterRestakingValidators(&_StakingContract.TransactOpts, pubkeys, signatures, podIds)
}

// RegisterRestakingValidators is a paid mutator transaction binding the contract method 0x0a1521fc.
//
// Solidity: function registerRestakingValidators(bytes[] pubkeys, bytes[] signatures, uint8[] podIds) returns()
func (_StakingContract *StakingContractTransactorSession) RegisterRestakingValidators(pubkeys [][]byte, signatures [][]byte, podIds []uint8) (*types.Transaction, error) {
	return _StakingContract.Contract.RegisterRestakingValidators(&_StakingContract.TransactOpts, pubkeys, signatures, podIds)
}
...
func (_StakingContract *StakingContractTransactor) RegisterRestakingValidators0(opts *bind.TransactOpts, pubkeys [][]byte, signatures [][]byte) (*types.Transaction, error) {
	return _StakingContract.contract.Transact(opts, "registerRestakingValidators0", pubkeys, signatures)
}

// RegisterRestakingValidators0 is a paid mutator transaction binding the contract method 0x4e8ab1a1.
//
// Solidity: function registerRestakingValidators(bytes[] pubkeys, bytes[] signatures) returns()
func (_StakingContract *StakingContractSession) RegisterRestakingValidators0(pubkeys [][]byte, signatures [][]byte) (*types.Transaction, error) {
	return _StakingContract.Contract.RegisterRestakingValidators0(&_StakingContract.TransactOpts, pubkeys, signatures)
}

// RegisterRestakingValidators0 is a paid mutator transaction binding the contract method 0x4e8ab1a1.
//
// Solidity: function registerRestakingValidators(bytes[] pubkeys, bytes[] signatures) returns()
func (_StakingContract *StakingContractTransactorSession) RegisterRestakingValidators0(pubkeys [][]byte, signatures [][]byte) (*types.Transaction, error) {
	return _StakingContract.Contract.RegisterRestakingValidators0(&_StakingContract.TransactOpts, pubkeys, signatures)
}
...
func (_StakingContract *StakingContractTransactor) ReplaceValidators(opts *bind.TransactOpts, oldpubkeys [][]byte, pubkeys [][]byte, signatures [][]byte, restaking bool, podIds []uint8) (*types.Transaction, error) {
	return _StakingContract.contract.Transact(opts, "replaceValidators", oldpubkeys, pubkeys, signatures, restaking, podIds)
}

// ReplaceValidators is a paid mutator transaction binding the contract method 0x4f13b2e3.
//
// Solidity: function replaceValidators(bytes[] oldpubkeys, bytes[] pubkeys, bytes[] signatures, bool restaking, uint8[] podIds) returns()
func (_StakingContract *StakingContractSession) ReplaceValidators(oldpubkeys [][]byte, pubkeys [][]byte, signatures [][]byte, restaking bool, podIds []uint8) (*types.Transaction, error) {
	return _StakingContract.Contract.ReplaceValidators(&_StakingContract.TransactOpts, oldpubkeys, pubkeys, signatures, restaking, podIds)
}

// ReplaceValidators is a paid mutator transaction binding the contract method 0x4f13b2e3.
//
// Solidity: function replaceValidators(bytes[] oldpubkeys, bytes[] pubkeys, bytes[] signatures, bool restaking, uint8[] podIds) returns()
func (_StakingContract *StakingContractTransactorSession) ReplaceValidators(oldpubkeys [][]byte, pubkeys [][]byte, signatures [][]byte, restaking bool, podIds []uint8) (*types.Transaction, error) {
	return _StakingContract.Contract.ReplaceValidators(&_StakingContract.TransactOpts, oldpubkeys, pubkeys, signatures, restaking, podIds)
}
...
// StakingContractClearedIterator is returned from FilterCleared and is used to iterate over the raw logs and unpacked data for Cleared events raised by the StakingContract contract.
type StakingContractClearedIterator struct {
	Event *StakingContractCleared // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *StakingContractClearedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(StakingContractCleared)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *StakingContractClearedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *StakingContractClearedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// StakingContractCleared represents a Cleared event raised by the StakingContract contract.
type StakingContractCleared struct {
	Amount *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}

// FilterCleared is a free log retrieval operation binding the contract event 0x6aa9b75b5139e8cd8f6d74d4d4d43cdd80d70cfc892d2f19dbd27539d3241661.
//
// Solidity: event Cleared(uint256 amount)
func (_StakingContract *StakingContractFilterer) FilterCleared(opts *bind.FilterOpts) (*StakingContractClearedIterator, error) {

	logs, sub, err := _StakingContract.contract.FilterLogs(opts, "Cleared")
	if err != nil {
		return nil, err
	}
	return &StakingContractClearedIterator{contract: _StakingContract.contract, event: "Cleared", logs: logs, sub: sub}, nil
}

// WatchCleared is a free log subscription operation binding the contract event 0x6aa9b75b5139e8cd8f6d74d4d4d43cdd80d70cfc892d2f19dbd27539d3241661.
//
// Solidity: event Cleared(uint256 amount)
func (_StakingContract *StakingContractFilterer) WatchCleared(opts *bind.WatchOpts, sink chan<- *StakingContractCleared) (event.Subscription, error) {

	logs, sub, err := _StakingContract.contract.WatchLogs(opts, "Cleared")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(StakingContractCleared)
				if err := _StakingContract.contract.UnpackLog(event, "Cleared", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseCleared is a log parse operation binding the contract event 0x6aa9b75b5139e8cd8f6d74d4d4d43cdd80d70cfc892d2f19dbd27539d3241661.
//
// Solidity: event Cleared(uint256 amount)
func (_StakingContract *StakingContractFilterer) ParseCleared(log types.Log) (*StakingContractCleared, error) {
	event := new(StakingContractCleared)
	if err := _StakingContract.contract.UnpackLog(event, "Cleared", log); err != nil {
		return nil, err
	}
...
// StakingContractUserRevenueCompoundedIterator is returned from FilterUserRevenueCompounded and is used to iterate over the raw logs and unpacked data for UserRevenueCompounded events raised by the StakingContract contract.
type StakingContractUserRevenueCompoundedIterator struct {
	Event *StakingContractUserRevenueCompounded // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *StakingContractUserRevenueCompoundedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(StakingContractUserRevenueCompounded)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *StakingContractUserRevenueCompoundedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *StakingContractUserRevenueCompoundedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// StakingContractUserRevenueCompounded represents a UserRevenueCompounded event raised by the StakingContract contract.
type StakingContractUserRevenueCompounded struct {
	Amount *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}
...
func (_StakingContract *StakingContractFilterer) FilterUserRevenueCompounded(opts *bind.FilterOpts) (*StakingContractUserRevenueCompoundedIterator, error) {

	logs, sub, err := _StakingContract.contract.FilterLogs(opts, "UserRevenueCompounded")
	if err != nil {
		return nil, err
	}
	return &StakingContractUserRevenueCompoundedIterator{contract: _StakingContract.contract, event: "UserRevenueCompounded", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event UserRevenueCompounded(uint256 amount)
func (_StakingContract *StakingContractFilterer) WatchUserRevenueCompounded(opts *bind.WatchOpts, sink chan<- *StakingContractUserRevenueCompounded) (event.Subscription, error) {

	logs, sub, err := _StakingContract.contract.WatchLogs(opts, "UserRevenueCompounded")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(StakingContractUserRevenueCompounded)
				if err := _StakingContract.contract.UnpackLog(event, "UserRevenueCompounded", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event UserRevenueCompounded(uint256 amount)
func (_StakingContract *StakingContractFilterer) ParseUserRevenueCompounded(log types.Log) (*StakingContractUserRevenueCompounded, error) {
	event := new(StakingContractUserRevenueCompounded)
	if err := _StakingContract.contract.UnpackLog(event, "UserRevenueCompounded", log); err != nil {
		return nil, err
	}
